...
class Config: 
    ...
    N_steps = config.getint("Network Stress", "N_epochs")
    initial_learning_rate = config.getfloat("Network Stress", "learning_rate")    
    ...
    N_steps_coords = config.getint("Network Coordinates", "N_epochs")
    initial_learning_rate_coords = config.getfloat("Network Coordinates", "learning_rate")    
